...
<style type="text/css">
#myCarousel img {height:300px; margin:0 auto;}
</style>
</head>
<body>
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="">FB Assignment</a>
...
<div class="container">
    <div class="page-header">
        <h1>Upload your pics to watch a slideshow</h1>
    </div>
    <div id="myCarousel" class="carousel slide">
      <!-- Carousel items -->
      <div class="carousel-inner" style="height:300px;">
        <div class="item active cat"><img src="http://placekitten.com/g/900/300"></div>
        <div class="item cat"><img src="http://placekitten.com/g/700/300"></div>
      </div>
      <!-- Carousel nav -->
...
<a href="https://twitter.com/intent/tweet?button_hashtag=SocialSlideshow&text=http://nab.bz/sosi"  class="twitter-share-button" data-related="jasoncosta" data-lang="en" data-size="large" data-count="none">Tweet</a>
